...
- `TWEAKS-PERSONAL/global-chat.md`: global `.` chat and labeled proximity-chat
...
- `DOCS-PERSONAL/planned/global-proximity-chat-plan.md`: planned `.` global and proximity chat feature.
